...
class TestEmployeeComputePayout(unittest.TestCase):
    ...
    def setUp(self): 
        """Set up test fixtures.""" #instead of creating a Employee object for every test case. setUp is called before every test
    ...
    def test_employee_payout_no_commission_no_hours(self):
        ...
        self.assertAlmostEqual(self.arjan.compute_payout(), 1000.0)  #using AlmostEqual so that there is no failing test case due to rounding error
