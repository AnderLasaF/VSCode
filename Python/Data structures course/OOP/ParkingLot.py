...
#x.ParkMotorcycle("MotorcycleSpot")
#print(x.motorcycle_spots_occupied) #THIS HAS TO BE ENCAPSULATED, SHOULD NOT BE EDITED FROM THE OUTSIDE
#x.motorcycle_spots_occupied=0
#print(x.motorcycle_spots_occupied)
print(Parking1.TotalNumberOfSpots())
print(Parking1.ParkingIsEmpty())
#print(Parking1.ParkCar('MotorcycleSpot'))
